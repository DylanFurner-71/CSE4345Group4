                        ...
                        <div className="card card-signin flex-row my-5">
                            <div className="card-body">
                                ...
                                <form className="form-signin" onSubmit={this.onSubmit}>
                                    ...
                                    <div className="custom-file form-label-group mt-2 mb-4">
                                        <input type="file" name="license" id="license" className="custom-file-input"/>
                                        <label className="custom-file-label" htmlFor="license">Upload License</label>
                                    </div>
