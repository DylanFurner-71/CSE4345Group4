...
const Services = ({ services, stylistId }) => {
    ...
    const URL = `http://${base_url}:8000/api/stylists/appointments/`;
    useEffect(() => {
                ...
                .then(res => {
                    ...
                    const availableAppointments = returnedAppointments.filter(
                        appointment =>
                            ...
                            new Date(appointment.endDate) > now
                    );
                    availableAppointments.sort(
                        (app1, app2) =>
                            new Date(app1.endDate) - new Date(app2.endDate)
                    );
                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-md-6 offset-md-3'>
                                <div
                                    className='m-3 p-2 border border-dark'
                                    key={i}
                                >
                                    <div className='row'>
                                        <div className='col-6'>
