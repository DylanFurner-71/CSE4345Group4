    ...
    if (user.user.role === 'stylist') {
        return (
            <div>
                ...
                >
                    <Navbar.Brand
                        href={`/stylistLanding/stylistId=${user.user.id}`}
                    >
                        Ultimate Style
                    </Navbar.Brand>
        ...
        return (
            <div>
                ...
                >
                    ...
                    <Navbar.Collapse id='basic-navbar-nav'>
                        <Nav className='mr-auto'>
                            ...
                            >
                                ...
                                <NavDropdown.Item
                                    href={
                                        searchURL + 'name=&service=waxing&min='
                                    }
                                >
                                    Waxing
                                </NavDropdown.Item>
                    ...
                    <a href={`${searchURL}name=${name}&service=&min=`}>
